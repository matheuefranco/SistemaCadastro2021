CREATE DATABASE  IF NOT EXISTS `siscadastro` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `siscadastro`;
...
INSERT INTO `bandas` VALUES (1,'ACDC','Rock',5,1),(2,'Molejo','Pagode',100,5),(3,'Titans','Rock',5,1),(4,'Skank','Pop/Rock',4,2),(5,'Nirvana','Rock',3,1),(7,'Metallica','Rock',4,1),(9,'Atitude67','Sertanejo',5,2),(10,'Jota Quest','Pop/Rock',5,1);
/*!40000 ALTER TABLE `bandas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'siscadastro'
--

--
-- Dumping routines for database 'siscadastro'
--
/*!50003 DROP PROCEDURE IF EXISTS `altera_banda` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `altera_banda`(id int, nome varchar(50), 
genero varchar(50), integrantes int, ranking int)
BEGIN
UPDATE `siscadastro`.`bandas`
SET
`nome` = nome,
`genero` = genero,
...
/*!50003 DROP PROCEDURE IF EXISTS `deleta_banda` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insere_banda` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `lista_bandas` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
-- Dump completed on 2021-12-22 19:18:49
